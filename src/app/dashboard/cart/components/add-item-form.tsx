					...
					<Form {...form}>
						...
						>
							...
							<div className="mt-3 flex gap-2.5">
								<Button
									type="submit"
									className="bg-cadetBlue font-gantari hover:bg-cadetBlue/85 px-1.2 mt-1.5 w-full flex-1 cursor-pointer overflow-hidden rounded py-2.5 text-sm text-white"
								>
